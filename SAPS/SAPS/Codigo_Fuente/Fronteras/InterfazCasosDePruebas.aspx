                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <asp:DropDownList runat="server" ID="drop_entradas_disponibles" CssClass="form-control" OnSelectedIndexChanged="drop_entradas_disponibles_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <hr />
